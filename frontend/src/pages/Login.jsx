        ...
        {!showForgot ? (
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="mt-8 pt-6 border-t border-slate-700/60">
              <span className="block text-center text-xs text-slate-500 font-medium mb-3">Quick Demo Logins</span>
              <div className="grid grid-cols-2 gap-2">
                <button
                  type="button"
                  onClick={() => handleDemoUser('admin')}
                  className="w-full py-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700 text-[11px] font-semibold rounded-lg text-slate-300 transition-all duration-200"
                >
                  Admin
                </button>
                <button
